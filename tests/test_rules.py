...
def test_is_white_in_check_pawn(board: Board) -> None:
    ...
    assert Rules.is_white_in_check(board) == False


def test_is_white_in_check_knight(board: Board) -> None:
    board.set_piece(Coordinate(3, 3), King(Color.WHITE))
...
def test_is_white_in_check_diagonal(board: Board) -> None:
    board.set_piece(Coordinate(3, 3), King(Color.WHITE))
...
def test_is_white_in_check_horizontal(board: Board) -> None:
    board.set_piece(Coordinate(3, 3), King(Color.WHITE))
