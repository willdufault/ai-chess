...
def test_get_legal_moves(board: Board) -> None:
    ...
    assert Rules.get_legal_moves(Color.WHITE, board) == [
        ...
        Move(
            Color.WHITE, Coordinate(0, 1), Coordinate(2, 2), Knight(Color.WHITE), None
        ),
        Move(
            Color.WHITE, Coordinate(0, 1), Coordinate(2, 0), Knight(Color.WHITE), None
        ),
        ...
        Move(
            Color.WHITE, Coordinate(0, 5), Coordinate(1, 4), Bishop(Color.WHITE), None
        ),
        Move(
            Color.WHITE, Coordinate(0, 5), Coordinate(2, 3), Bishop(Color.WHITE), None
        ),
        Move(
            Color.WHITE, Coordinate(0, 5), Coordinate(3, 2), Bishop(Color.WHITE), None
        ),
        Move(
            Color.WHITE, Coordinate(0, 5), Coordinate(4, 1), Bishop(Color.WHITE), None
        ),
        Move(
            Color.WHITE, Coordinate(0, 5), Coordinate(5, 0), Bishop(Color.WHITE), None
        ),
        Move(
            Color.WHITE, Coordinate(0, 6), Coordinate(1, 4), Knight(Color.WHITE), None
        ),
        Move(
            Color.WHITE, Coordinate(0, 6), Coordinate(2, 7), Knight(Color.WHITE), None
        ),
        Move(
