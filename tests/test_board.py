...
class TestMove(TestCase):
    ...
    def test_is_under_attack_out_of_bounds(self) -> None:
        self.assertFalse(self.board.get_attacker_coords(BOARD_SIZE, 0, Color.WHITE))

    def test_is_under_attack_straight(self) -> None:
        self.board.set_piece(5, 3, Queen(Color.WHITE))
        self.assertTrue(self.board.get_attacker_coords(3, 3, Color.WHITE))

        self.board.set_piece(4, 3, Bishop(Color.WHITE))
        self.assertFalse(self.board.get_attacker_coords(3, 3, Color.WHITE))
