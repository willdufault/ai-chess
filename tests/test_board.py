...
class TestMove(TestCase):
    ...
    def test_blocked_vertical(self) -> None:
        self.assertFalse(self.board.is_blocked(0, 0, 1, 0))
        self.assertTrue(self.board.is_blocked(0, 0, 2, 0))

    def test_blocked_horizontal(self) -> None:
        self.assertFalse(self.board.is_blocked(0, 0, 0, 1))
        self.assertTrue(self.board.is_blocked(0, 0, 0, 2))

    def test_blocked_diagonal(self) -> None:
        self.assertFalse(self.board.is_blocked(0, 0, 1, 1))
        self.assertTrue(self.board.is_blocked(0, 0, 2, 2))
    ...
    def test_is_in_checkmate(self) -> None:
        ...
        self.board._set_piece(1, 4, Queen(Color.BLACK))
        self.assertFalse(self.board.is_in_checkmate(Color.WHITE))

        self.board._set_piece(3, 2, Bishop(Color.BLACK))
        self.assertFalse(self.board.is_in_checkmate(Color.WHITE))

        self.board._set_piece(0, 3, Rook(Color.WHITE))
        self.assertFalse(self.board.is_in_checkmate(Color.WHITE))

        self.board._set_piece(0, 5, Rook(Color.WHITE))
        self.assertFalse(self.board.is_in_checkmate(Color.WHITE))

        self.board._set_piece(0, 6, None)
        self.assertTrue(self.board.is_in_checkmate(Color.WHITE))

        self.board._set_piece(1, 4, Rook(Color.BLACK))
        self.assertTrue(self.board.is_in_checkmate(Color.WHITE))

        self.board._set_piece(3, 2, None)
        self.assertFalse(self.board.is_in_checkmate(Color.WHITE))

    def test_is_in_checkmate_block(self) -> None:
        self.board._set_piece(1, 3, None)
        self.board._set_piece(3, 1, Bishop(Color.BLACK))
        self.assertFalse(self.board.is_in_checkmate(Color.WHITE))

        self.board._set_piece(1, 2, None)
        self.assertFalse(self.board.is_in_checkmate(Color.WHITE))

        self.board._set_piece(0, 3, Bishop(Color.WHITE))
        self.assertFalse(self.board.is_in_checkmate(Color.WHITE))

        self.board._set_piece(0, 2, None)
        self.assertFalse(self.board.is_in_checkmate(Color.WHITE))

        self.board._set_piece(0, 1, None)
        self.assertTrue(self.board.is_in_checkmate(Color.WHITE))

        self.board._set_piece(0, 5, None)
        self.assertFalse(self.board.is_in_checkmate(Color.WHITE))

    def test_is_in_checkmate_capture(self) -> None:
        self.board._set_piece(1, 5, None)
        self.board._set_piece(2, 6, Bishop(Color.BLACK))
        self.assertFalse(self.board.is_in_checkmate(Color.WHITE))

        self.board._set_piece(1, 7, None)
        self.assertTrue(self.board.is_in_checkmate(Color.WHITE))

        self.board._set_piece(2, 0, Rook(Color.WHITE))
        self.assertFalse(self.board.is_in_checkmate(Color.WHITE))

    def test_is_in_checkmate_pin(self) -> None:
        self.board._set_piece(1, 5, None)
        self.board._set_piece(1, 6, None)
        self.board._set_piece(3, 7, Bishop(Color.BLACK))
        self.assertTrue(self.board.is_in_checkmate(Color.WHITE))

        self.board._set_piece(1, 4, Rook(Color.WHITE))
        self.assertFalse(self.board.is_in_checkmate(Color.WHITE))

        self.board._set_piece(3, 4, Rook(Color.BLACK))
        self.assertTrue(self.board.is_in_checkmate(Color.WHITE))

        self.board._set_piece(0, 3, None)
        self.assertFalse(self.board.is_in_checkmate(Color.WHITE))

    def test_is_in_checkmate_double_check(self) -> None:
        self.board._set_piece(1, 1, None)
        self.board._set_piece(1, 3, None)
        self.board._set_piece(1, 4, None)
        self.board._set_piece(5, 4, Rook(Color.BLACK))
        self.assertFalse(self.board.is_in_checkmate(Color.WHITE))

        self.board._set_piece(2, 2, Bishop(Color.BLACK))
        self.assertTrue(self.board.is_in_checkmate(Color.WHITE))
